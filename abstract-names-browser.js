// Abstract names for AI avatars - Browser version
const ABSTRACT_NAMES = [
  ...
  { name: "BLAKE", expansion: "Agent for Learning, Analysis, Knowledge & Exploration" },
  ...
  { name: "BAY", expansion: "Agent for Adaptive Yield" },
